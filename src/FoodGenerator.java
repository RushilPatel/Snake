...
public final class FoodGenerator {
    ...
    private final int length; // length of the frame
    private final int height; // height frame
    ...
    // Generate random xCoordinate for the food
    public int newX () {
        // return a randomly generated x-value
        return randomValue (rng.nextInt (length + 1));
    }

    public int newY () {
        // return a randomly generated y-value
        return randomValue (rng.nextInt (height + 1));
    }
